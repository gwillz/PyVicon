...
static PyObject* pyvicon_newclient(PyObject* self, PyObject* args) {
    ...
    return PyCapsule_New(vicon_client, NULL, NULL);
}
...
static PyObject* pyvicon_connect(PyObject* self, PyObject* args) {
    ...
    //parse args
    if (!PyArg_ParseTuple(args, "Os", &capsule, &input))
        return NULL;
    client = (Client*)PyCapsule_GetPointer(capsule, NULL);
...
static PyObject* pyvicon_setstreammode(PyObject* self, PyObject* args) {
    ...
    //parse the argument
    if (!PyArg_ParseTuple(args, "Oi", &capsule, &input))
        return NULL;
    client = (Client*)PyCapsule_GetPointer(capsule, NULL);
...
static PyObject* pyvicon_subjectname(PyObject* self, PyObject* args) {
    ...
    if (!PyArg_ParseTuple(args, "OI", &capsule, &index))
        return NULL;
    client = (Client*)PyCapsule_GetPointer(capsule, NULL);
